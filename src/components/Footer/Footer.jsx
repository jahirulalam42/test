...
const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 bg-blue-900 text-white">
        <nav>
          ...
          <div className="flex py-6">
            ...
            <a className="link px-6">Terms of Service</a>
          </div>
      ...
      <div className="bg-blue-900 text-white text-xs pl-10 pb-20">
        <p>
          Apple, the Apple logo, and iPhone are trademarks of Apple Inc.,
          registered in the U.S. and other <br /> countries. App Store is a
          service mark of Apple Inc. Android, Google Play and the Google Play{" "}
